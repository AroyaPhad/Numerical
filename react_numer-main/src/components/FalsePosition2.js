...
const FalsePosition2 = () => {
  ...
  const sendRequest = async () => {
    const response = await fetch("http://localhost:5000/api/get-bisection", {
      headers: {
          authorization: `Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJlbWFpbCI6ImJ5b3VAYnlvdS5jb20iLCJwYXNzd29yZCI6IjEyMzQ1IiwiaWF0IjoxNjUzNjQ2OTQwLCJleHAiOjE2ODUxODI5NDB9.fEWbVjbcVIya97mIfBd6Kw0BhIT2jkKXSu5gLl0bLmk`,
      },
  });
